...
graph2 <- ggplot(data = lake, aes(x = fct_reorder(lake_id, total_count), y = total_count)) +
  geom_col(aes(fill = lake_id)) +
  labs(x = ' ', y = 'Yellow-Legged Frog Count') +
  theme_minimal(10) +
  scale_fill_manual(values = c('steelblue4', 'steelblue3', 'steelblue2', 'skyblue1', 'slategray1')) +
