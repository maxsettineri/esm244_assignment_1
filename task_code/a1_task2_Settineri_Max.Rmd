...
- The Delta BIC value of `r round(aictable$Delta_BIC[2], 2)` is small, providing weak evidence that model 2 is better fit. This difference in delta AIC versus delta BIC is likely due to BIC penalizing model 2 for having 4 parameters to model 1's 3 parameters. 
